...
public class Constant {
    public static final String IODT = "yyyyMMddHHmmss.SSS";
    public static final String YYYY_MM_DD_HH_MM_SS = "yyyy-MM-dd HH:mm:ss";
    public static final String YYYYMMDD = "yyyyMMdd";
    public static final String YYYY_MM_DD = "yyyy-MM-dd";
    public static final String EMAIL_REGEXP = "^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$";
    public static final String PHONE_REGEXP = "^[1][3,4,5,7,8][0-9]{9}$";
    public static final String EMPTY_STR = "";
    public static final String NUMBER_SEQ = "1234567890";
